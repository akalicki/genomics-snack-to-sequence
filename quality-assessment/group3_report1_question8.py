...
poretools tabular -q --type 2D pass/ > 2d_files.txt
poretools tabular -q --type 2D fail/ >> 2d_files.txt
poretools times -q pass/ > times.txt
poretools times -q fail/ >> times.txt
